...
const translations: Record<Language, Translations> = {
  id: {
    ...
    // Predictions View
    predictionsTitle: 'Prediksi & Simulator Risiko',
    predictionsSub: 'Lakukan simulasi skenario What-If untuk memprediksi probabilitas churn dalam kondisi pelanggan yang diubah.',
    simulationInputVariables: 'Variabel Input Simulasi',
    resetHealthyBaseline: 'Reset ke Baseline Sehat',
    supportTicketsLast30: 'Tiket Dukungan (30 Hari Terakhir)',
    tickets: 'tiket',
    daysUntilRenewal: 'Hari Hingga Perpanjangan Kontrak',
    days: 'hari',
    weeklyActiveLogins: 'Login Aktif Mingguan per Pengguna',
    loginsPerWeek: 'login/minggu',
    coreFeatureAdoptionRate: 'Tingkat Adopsi Fitur Inti',
    customerSatisfactionCSAT: 'Kepuasan Pelanggan (Skor CSAT)',
    simulatedPredictionOutput: 'Output Prediksi Simulasi',
    predictedChurnRiskScore: 'Skor Risiko Churn yang Diprediksi',
    highChurnRiskLabel: 'RISIKO CHURN TINGGI',
    mediumChurnRiskLabel: 'RISIKO CHURN SEDANG',
    lowChurnRiskLabel: 'RISIKO CHURN RENDAH',
    aiDiagnosis: 'Diagnosis AI:',
    rerunPredictiveModel: 'Jalankan Ulang Model Prediktif Lengkap',
    highRiskDrivenBy: 'Risiko tinggi didorong oleh tiket dukungan yang sering dan perpanjangan kontrak yang mendekati dalam 45 hari.',
  ...
  en: {
    ...
    predictionsTitle: 'Predictions & Risk Simulator',
    predictionsSub: 'Perform What-If scenario simulations to predict churn probability under altered customer conditions.',
    simulationInputVariables: 'Simulation Input Variables',
    resetHealthyBaseline: 'Reset to Healthy Baseline',
    supportTicketsLast30: 'Support Tickets (Last 30 Days)',
    tickets: 'tickets',
    daysUntilRenewal: 'Days Until Contract Renewal',
    days: 'days',
    weeklyActiveLogins: 'Weekly Active Logins per User',
    loginsPerWeek: 'logins/wk',
    coreFeatureAdoptionRate: 'Core Feature Adoption Rate',
    customerSatisfactionCSAT: 'Customer Satisfaction (CSAT Score)',
    simulatedPredictionOutput: 'Simulated Prediction Output',
    predictedChurnRiskScore: 'Predicted Churn Risk Score',
    highChurnRiskLabel: 'HIGH CHURN RISK',
    mediumChurnRiskLabel: 'MEDIUM CHURN RISK',
    lowChurnRiskLabel: 'LOW CHURN RISK',
